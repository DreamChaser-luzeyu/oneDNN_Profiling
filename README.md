...
IN_FILE="$(pwd)/input/default.in" make test_matmul_aarch64forcenosve
IN_FILE="$(pwd)/input/default.in" make test_matmul_aarch64forcenosimd
...
IN_FILE="$(pwd)/input/default.in" taskset -c 1 make test_matmul_aarch64forcenosve
IN_FILE="$(pwd)/input/default.in" taskset -c 1 make test_matmul_aarch64forcenosimd
